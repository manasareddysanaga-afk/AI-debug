...
└── README.md
⚙️ How It Works
User enters a bug description in the UI
React sends request to FastAPI backend (/solve)
Backend processes input using rule-based AI logic
System identifies bug category (React, API, Null error, etc.)
Returns structured response:
Cause
Fix
Example
UI displays formatted solution
🔌 API Endpoints
🔹 GET /
